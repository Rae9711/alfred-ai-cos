...
# Do NOT use is.workflow.actions.properties.messages / contentitemproperties.
# Those IDs resolve as "Unknown Action" on many iOS builds and strip Dictionary items.
